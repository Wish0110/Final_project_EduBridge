  ...
  return (
    <Sidebar>
      <div>
        ...
        <label>
          •Guide to writing your personal statement (opens in a new window) <br />
          should help you complete this section.<br />
          •We strongly recommend you write the statement using a word-processor and <br />
          paste it in to your application.<br />
